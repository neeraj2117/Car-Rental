...
const Testimonial = () => {
  return (
    <div className="text-center mt-40 mb-30">
      <h1 className="text-4xl md:text-4xl font-semibold text-gray-900">
      ...
      <div className="flex flex-wrap justify-center gap-6 mt-20 text-left">
        <div
          className="w-100 flex flex-col items-start border cursor-pointer shadow-sm hover:shadow-md border-gray-200 p-5 rounded-lg bg-white 
    transform transition-transform duration-300 hover:-translate-y-1 hover:scale-102"
        >
          <svg
            width="44"
            height="40"
