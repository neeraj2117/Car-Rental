...
//               onChange={(e) => setPickupDate(e.target.value)}
//               min={new Date().toISOString().split("T")[0]}
//               className="border border-gray-300 rounded px-3 py-2 text-sm text-gray-700 focus:border-indigo-500"
//               required
//             />
//           </div>
...
//         <button
//           type="submit"
//           className="flex items-center justify-center gap-2 px-10 py-3 max-sm:mt-4
//           bg-primary hover:bg-primary-dull font-light text-[18px] text-white rounded-full cursor-pointer"
//         >
//           <img src={assets.search_icon} alt="search" className="brightness-300" />
//           Search
