...
const Footer = () => {
  return (
    <div className="text-gray-500/80 bg-gray-50 pt-8 px-6 md:px-16 lg:px-24 xl:px-32">
      <div className="flex flex-wrap justify-between gap-12 md:gap-6">
        ...
        <div>
          <p className="text-lg text-blue-600">SUPPORT</p>
          <ul className="mt-3 flex flex-col gap-2 text-sm">
            <li>
        ...
        <div className="max-w-80">
          <p className="text-lg text-blue-600">STAY UPDATED</p>
      ...
      <div className="flex flex-col md:flex-row gap-2 items-center justify-between py-5">
        ...
        <ul className="flex items-center gap-4">
          <li>
            <a href="#">Privacy <span className="ml-4"> |</span></a>
          </li>
          <li>
            <a href="#">Terms <span className="ml-4"> |</span></a>
          </li>
          <li>
            <a href="#">Sitemap</a>
          </li>
